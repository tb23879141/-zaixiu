...
namespace ScreenshotTool
{
    ...
    public class CaptureToolButton : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (this._Image == null)
                g.DrawImage(global::ScreenshotTool.Properties.Resources.src_image_none, new Rectangle(2, 2, 21, 21));
            else
                g.DrawImage(this._Image, new Rectangle(2, 2, 21, 21));
            using (SolidBrush sb = new SolidBrush(this.ForeColor))
            {
                g.DrawString(this.Text, this.Font, sb, 25, (this.Height - this.Font.Height) / 2);
            }
            if (this._IsSelected)
        ...
        {
            base.SetBoundsCore(x, y, TextRenderer.MeasureText(this.Text, this.Font).Width + 25, 25, specified);
        }
    }
}
