...
public class PostCall
{
    ...
    public PostCall(string url, string requestParams)
    {
        requstUrl = url;
        this.requestParams = requestParams;
    }

    public PostCall AddErrorListener(Action<int, string> callback)
    {
        mErrListener = callback;
        return this;
    }

    public PostCall BindTag(string tag)
    {
        this.tag = tag;
        return this;
    }
    ...
    public void Execute(Action<bool, Dictionary<string, object>> callback)
    {
        ...
        Task.Factory.StartNew(() =>
        {
            try
            {
                ...
                if (!UIUtils.IsNull(requestParams))
                {
                ...
                LogUtils.Log("http-post请求：" + requstUrl + "?" + requestParams);
                // 获得响应流
