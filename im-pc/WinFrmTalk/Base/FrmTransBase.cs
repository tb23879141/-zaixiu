...
namespace WinFrmTalk.Base
{
    public partial class FrmTransBase : Form
    {
        ...
        public new DialogResult ShowDialog(IWin32Window owner)
        {
            try
            {
                if (this._isShowMaskDialog && owner != null)
                {
                    ...
                    FrmGiftTip _frmTransparent = new FrmGiftTip();
        ...
        {
            base.OnClosed(e);
            if (base.Owner != null && base.Owner is FrmGiftTip)
            {
                (base.Owner as FrmGiftTip).Close();
            }
