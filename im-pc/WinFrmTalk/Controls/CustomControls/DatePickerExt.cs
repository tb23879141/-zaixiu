...
namespace WinFrmTalk.Controls.CustomControls
{
    ...
    public partial class DateExt : Control
    {
        ...
        public DateExt()
        {
            ...
            this.SetStyle(ControlStyles.UserPaint, true); //控件自行绘制，而不使用操作系统的绘制
            this.SetStyle(ControlStyles.AllPaintingInWmPaint, true);  //忽略擦出的消息，减少闪烁。
            this.SetStyle(ControlStyles.OptimizedDoubleBuffer, true); //在缓冲区上绘制，不直接绘制到屏幕上，减少闪烁。
            this.SetStyle(ControlStyles.ResizeRedraw, true); //控件大小发生变化时，重绘。       
            this.SetStyle(ControlStyles.SupportsTransparentBackColor, true); //支持透明背景颜色
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            string date_format = this.DatePicker.DateDisplayType == DatePickerExt.DateDisplayTypes.Year ? "yyyy年" : (this.DatePicker.DateDisplayType == DatePickerExt.DateDisplayTypes.YearMonth ? "yyyy年MM月" : "yyyy年MM月dd日");
            int image_width = Properties.Resources.RegisterDateEx.Width;
            int image_height = Properties.Resources.RegisterDateEx.Height;
            ...
            g.DrawImage(Properties.Resources.RegisterDateEx, image_rect);
    ...
    public partial class DatePickerExt : Control
    {
        ...
        private void DrawBottomBar(Graphics g)
        {
            ...
            g.FillPath(now_btn_back_sb, TransformCircular(this.DateObject.DateBottomBar.bottombar_now_btn.Rect, 4, 0, 0, 4));
        ...
        private void UpdateControlText()
        {
            ...
            #endregion
            #region 底部工具栏
            //string strformat = this.DateDisplayType == DateDisplayTypes.Year ? "yyyy" : (this.DateDisplayType == DateDisplayTypes.YearMonth ? "yyyy年MM" : "yyyy年MM月dd日");
        ...
        public class BottomBarClass
        {
            ...
            public BottomBarClass(DatePickerExt parent, DateClass ower)
            {
                ...
                this.bottombar_now_btn = new BottomBarItemClass(parent, ower) { Text = "今天", MoveStatus = DateItemMoveStatuss.Normal };
