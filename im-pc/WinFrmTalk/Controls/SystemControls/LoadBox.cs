...
namespace WinFrmTalk
{
    class LoadBox: Control
    {
        ...
        private readonly Color DefaultColor = Color.Gray;//系统定义的颜色
        ...
        public Color Color
        {
            ...
            set
            {
                m_Color = Color.FromArgb(this._alpha, Color.Black);
        ...
        public LoadBox()
        {
            //this.BackColor = Color.FromArgb(this.Alpha,Color.Black);
