    ...
    public partial class XListView : UserControl
    {
        ...
        public void RefreshItemEnd()
        {
            ...
            try
            {
                ...
                var pos = panel1.Location.Y;
                ClearList();

                var total = GetListHeight();
                panel1.Height = total;
            ...
            catch (Exception ex) { LogUtils.Error("============================SetAdapterXListView============================\r\n" + ex.Message); }
            finally
            {
                this.ResumeLayout();
            }
            ...
            vScrollBar.Visible = panel1.Height > ViewHeight;
        }
        ...
        public void SetAdapter(IBaseAdapter adapter)
        {
            ...
            catch (Exception ex) { LogUtils.Error("============================XListView============================\r\n" + ex.Message); }
        ...
        public void ClearList()
        {
            ...
            bool isClear = false;
            if (mCacheHeight != null && mCacheHeight.Length != 0)
            {
                isClear = true;
            }
        ...
        internal void MyMouseWheel(MouseEventArgs e)
        {
            View_MouseWheel(this, e);
        }
