...
public class ToolStripRendererEx : ToolStripRenderer
{
        ...
        ToolStripSeparatorRenderEventArgs e)
    {
        ...
        Graphics g = e.Graphics;
        ToolStripSeparator separator = e.Item as ToolStripSeparator;
        if (separator != null)
        {
            StripSeparatorLine(g, rect, Color.LightGray);
        }
    }
    ...
    //    else
    //    {
    //        rect.X += OffsetMargin + 1;
    //    }
    //    rect.Width -= OffsetMargin + 1;
    //    rect.Height--;
    ...
    internal void StripSeparatorLine(Graphics g,Rectangle bounders, Color color)
    {
      
        bounders.Y += 3;
        bounders.Height = Math.Max(0, bounders.Height -4);
        if (bounders.Height >= 4) bounders.Inflate(0, -2);
        Pen pen = new Pen(color,1);
        int x = bounders.Width / 2;
        g.DrawLine(pen, x, bounders.Top, x, bounders.Bottom - 1);
        pen.Dispose();
        pen = new Pen(color,1);
        g.DrawLine(pen, x + 1, bounders.Top + 1, x + 1, bounders.Bottom);
        pen.Dispose();
    }
